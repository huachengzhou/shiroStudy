...
<body>
	...
	<div class="TestdivA">
		<div class="TestdivB">
			<h4>List Page</h4><br/>
			<shiro:user>欢迎<shiro:principal /> <button id="btnSubmit" class="btn btn-info mx">退出</button></shiro:user><br/>
		</div>
		<div class="TestdivB">
			<shiro:hasRole name="admin"><a href="${pageContext.request.contextPath}/admin.jsp" class="btn btn-info mx">admin</a></shiro:hasRole><br/>
			<shiro:hasRole name="user"><a href="${pageContext.request.contextPath}/user.jsp" class="btn btn-info mx">user</a></shiro:hasRole><br/>
			<a class="btn-info btn" href="${pageContext.request.contextPath}/shiro/testShiroAnnotation.action">testShiroAnnotation</a><br/>
		</div>
	</div>
